export function FormEmail(){
    return(
        <div className="divBase rsitePallete">
            ...
            <form action="https://getform.io/f/aqoqorra" method="POST" className="w-full lg:w-1/3 h-full sitePallete flex flex-col border-2 rounded-2xl p-5 gap-4 border-defaultBg dark:border-darkdefaultBg">
